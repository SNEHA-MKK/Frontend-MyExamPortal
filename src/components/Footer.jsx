            ...
            <div className=' w-100 p-4' style={{ backgroundColor: 'rgba(102, 145, 180, 0.856)' }} >
                <div className="row mx-md-5 mx-3">
                    ...
                    <div className="col-md-4">
                        ...
                        <h3 className='mb-3 text-light'><FontAwesomeIcon icon={faStackOverflow} className='me-2' />Exam Portal</h3>
                    ...
                    <div className="col-md-1">
                        ...
                        <Link style={{ textDecoration: 'none', color: 'black' }} to={'/project'}><p>Exams</p></Link>
                ...
                <p className='text-center text-light'>copyright © 2024 latest Exams.Built with react</p>
            </div>
