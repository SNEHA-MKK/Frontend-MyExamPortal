        ...
        <>
            ...
            <div style={{ backgroundImage: "url('https://media.istockphoto.com/id/1253222652/vector/abstract-light-blue-wavy-modern-curve-lines-on-top-and-bottom-with-clean-background-vector.jpg?s=612x612&w=0&k=20&c=h0Cemf1DEK58s4lJSzot_o1mEm9_VAakPMaA4xCHXeg=')", backgroundSize: 'cover', backgroundPosition: 'center', height: '100vh' }}>
                <div className="container "   >
                    <h2 className="text-center text-info p-3" style={{ fontFamily: 'cursive' }} >All Users</h2>
                    <div>
                        <Table striped bordered rounded hover responsive className='mt-3' style={{
                            ...
                            <thead style={{ backgroundColor: '#007bff', fontFamily: "cursive" }}>
                                <tr>
                                    <th className="text-info text-center" style={{ fontFamily: 'cursive' }}>Serial No.</th>
                                    <th className="text-info text-center" style={{ fontFamily: 'cursive' }}>NAME</th>
                                    <th className="text-info text-center" style={{ fontFamily: 'cursive' }}>EMAIL</th>
                                    <th className="text-info text-center" style={{ fontFamily: 'cursive' }}>PHONE</th>
                                    <th className="text-info text-center" style={{ fontFamily: 'cursive' }}>QUALIFICATION</th>
                                </tr>
                            </thead>
                            <tbody>
