...
import { deleteAQuestApi, getAllAdmQuestion } from "../../../services/allAPI";
...
const AdminQuestionsPage = () => {
    ...
    const deleteAdmQuest = async (id) => {
        ...
        if (sessionStorage.getItem("token")) {
            ...
            const result = await deleteAQuestApi(id, reqHeader)
            console.log(result);
                                            ...
                                            <Col xs={12}>
                                                ...
                                                <div className="d-flex justify-content-between">
                                                    ...
                                                    <Button variant="outline-danger">
                                                        <FontAwesomeIcon onClick={() => deleteAdmQuest(item._id)} icon={faTrash} className='text-danger' />
                                                    </Button>
                                                </div>
                                            </Col>
